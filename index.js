...
//    const snakeMove = spinInCircles();
    ...
    const { turn } = data;
    const zigZagMove = () => {
        const possibleMoves = ["up", "right", "right", "right", "down", "down", "left", "left", "down", "down", "right", "up"];
        return possibleMoves[turn % 12 ]; //go up then turn right, then go down turn left
    };
